...
class LightingScene extends CGFscene 
{
	...
	init(application) 
	{
		...
		this.cylinderTop = new MyCylinderTop(this,8);
		...
		this.materialC.setDiffuse(1,0.8,0.6,1);
		...
		this.materialD.setDiffuse(0.2,0.0,0.0,1);
		this.materialD.setSpecular(0.2,0.2,0.2,1);	
		this.materialD.setShininess(120);

		//Textures
		this.windowAppearance = new CGFappearance(this);
		this.windowAppearance.setSpecular(0.1, 0.1, 0.1, 1);
		this.windowAppearance.setShininess(0.1);
	...
	initLights() 
	{
		...
		this.lights[0].setPosition(4, 6.0, 1.0, 1.0);
